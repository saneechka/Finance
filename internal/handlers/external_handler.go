...
func SubmitSalaryProject(c *gin.Context) {
	...
	// Check if user has external specialist role
	...
	// Create a unique ID for the salary project submission
...
func RequestEnterpriseTransfer(c *gin.Context) {
	...
	// This would ideally check against a database of enterprise-to-user mappings
...
func GetUserEnterprises(c *gin.Context) {
	...
	// Retrieve enterprises for the user
